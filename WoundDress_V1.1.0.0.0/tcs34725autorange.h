...
//
const tcs34725Autorange::tcs_agc tcs34725Autorange::agc_lst[] = {
...
tcs34725Autorange::tcs34725Autorange() : agc_cur(0), isAvailable(0), isSaturated(0) {
}

// initialize the sensor
boolean tcs34725Autorange::begin(void) {
...
void tcs34725Autorange::setGainTime(void) {
...
void tcs34725Autorange::getData(void) {
...
void GetColorData(void) {
  rgb_sensor.getData();
 

  Serial.print(rgb_sensor.r);Serial.print(" ");

  Serial.print(rgb_sensor.g);Serial.print(" ");

  Serial.print(rgb_sensor.b);Serial.print(" ");

  Serial.println(rgb_sensor.c);Serial.print(" ");


  Serial.print(rgb_sensor.ir);Serial.print(" ");

  Serial.print(rgb_sensor.cratio);Serial.print(" ");

  Serial.print(rgb_sensor.saturation);Serial.print(" ");

  Serial.print(rgb_sensor.saturation75);Serial.print(" ");




  Serial.print(rgb_sensor.cpl);Serial.print(" ");

  Serial.println(rgb_sensor.maxlux);Serial.print(" ");


  Serial.print(rgb_sensor.r_comp);Serial.print(" ");

  Serial.print(rgb_sensor.g_comp);Serial.print(" ");

  Serial.print(rgb_sensor.b_comp);Serial.print(" ");

  Serial.println(rgb_sensor.c_comp);Serial.print(" ");

  Serial.print(rgb_sensor.lux);Serial.print(" ");

  Serial.print(rgb_sensor.ct);Serial.print(" ");
