...
void setup(void) {
  ...
  if (sensorStatus) {
	...
	else{Serial.println("Found sensor");sensorStatus=false;break;}
	}
  }
...
for(itt=0;itt<50;itt++)
{
 ...
 tvoc=temp_tvoc/itt;
 Serial.print("CO2: ");
 	  if(CO2>400){Serial.print(CO2);}
      else{Serial.print("<=400");} // the threshold for CO2 detection is at 400 ppm at the minimum
